				...
				<div class="col-sm-6 col-md-4 col-lg-3 ">
					<label>
						<div class="thumbnail">
							...
							<img src="<%=request.getContextPath()%>/images/wechat.jpg" alt="微信支付">
						</div>
					</label>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3 ">
					<label>
						<div class="thumbnail">
							...
							<img src="<%=request.getContextPath()%>/images/alipay.jpg" alt="支付宝支付">
						</div>
					</label>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3 ">
					<label>
						<div class="thumbnail">
							...
							<img src="<%=request.getContextPath()%>/images/offline.jpg" alt="货到付款">
						</div>
					</label>
				</div>
